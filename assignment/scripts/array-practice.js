...
let favoriteFoods = ['pizza', 'sushi', 'tacos', 'ice cream'];
...
console.log('Last animal is:', lastAnimalRefactored);
...
console.log('Replaced second gem:', gems);
